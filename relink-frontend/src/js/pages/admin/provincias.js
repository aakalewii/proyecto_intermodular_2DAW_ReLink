    ...
    try {
        ...
        provincias.forEach(provincia => {
            ...
            tr.innerHTML = `
                ...
                <td>${nombreDelPais}</td>
                <td>
                    <button class="btn-editar" data-id="${provincia.id}" data-nombre="${provincia.nombre}" data-pais-id="${provincia.pais_id}">Editar</button>
                    <button class="btn-borrar" data-id="${provincia.id}">Borrar</button>
                </td>
            `;
